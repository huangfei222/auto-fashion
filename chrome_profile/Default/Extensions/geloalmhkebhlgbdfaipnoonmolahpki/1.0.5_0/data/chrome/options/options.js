...
$(document).on('ready', function() {
  ...
  var checkboxes = $('input[type="checkbox"]').each(function () {
    ...
    // Specific deserialization for this Firefox data collection setting
      ...
      var settingValue = localStorage.getItem('socialbee.op.firefox-disable-data-collection');
  ...
  var radios = $('input[type="radio"]').each(function () {
    var $this = $(this);
    var key = 'socialbee.op.' + $this.attr('name');
    var val = $this.val();
  ...
  $('.submit').click(function (ev) {
    ...
    if( ! localStorage.getItem('socialbee.reviewed') ) {
      var webstoresCopy = {
        chrome: 'the <a class="fivestars" href="https://chrome.google.com/webstore/detail/socialbee/noojglkidnpfjbincgijbaiedldjfbhh" target="_bank">Chrome Web Store</a>',
        firefox: '<a class="fivestars" href="https://addons.mozilla.org/en-US/firefox/addon/socialbee-for-firefox/" target="_bank">Mozilla Add-ons</a>',
      };
  ...
  $('body').on('click', '.fivestars', function () {
    localStorage.setItem('socialbee.reviewed', 'true');
