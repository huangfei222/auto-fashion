...
;(function(){
  ...
  button.id = 'socialbee-extension-hover-button';
  ...
  (function check() {
    ...
    if (typeof xt.options['socialbee.op.image-overlays'] === 'undefined' ||
        xt.options['socialbee.op.image-overlays'] === 'image-overlays') {
