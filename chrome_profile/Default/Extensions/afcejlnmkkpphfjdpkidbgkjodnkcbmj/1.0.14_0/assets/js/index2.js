import { j as jsxDEV, ap as NextUIProvider, r as react, K as Fragment, v as reactDom } from "./jsx-dev-runtime.js";
const css = `/*
...
.mx-\\[calc\\(\\(theme\\(spacing\\.5\\)-theme\\(spacing\\.1\\)\\)\\/2\\)\\] {
  margin-left: calc((20px - 4px) / 2);
  margin-right: calc((20px - 4px) / 2);
}
.mx-\\[calc\\(\\(theme\\(spacing\\.6\\)-theme\\(spacing\\.3\\)\\)\\/2\\)\\] {
  margin-left: calc((24px - 12px) / 2);
  margin-right: calc((24px - 12px) / 2);
}
.mx-\\[calc\\(\\(theme\\(spacing\\.7\\)-theme\\(spacing\\.5\\)\\)\\/2\\)\\] {
  margin-left: calc((28px - 20px) / 2);
  margin-right: calc((28px - 20px) / 2);
}
.my-0 {
  margin-top: 0px;
  margin-bottom: 0px;
...
.my-\\[calc\\(\\(theme\\(spacing\\.5\\)-theme\\(spacing\\.1\\)\\)\\/2\\)\\] {
  margin-top: calc((20px - 4px) / 2);
  margin-bottom: calc((20px - 4px) / 2);
}
.my-\\[calc\\(\\(theme\\(spacing\\.6\\)-theme\\(spacing\\.3\\)\\)\\/2\\)\\] {
  margin-top: calc((24px - 12px) / 2);
  margin-bottom: calc((24px - 12px) / 2);
}
.my-\\[calc\\(\\(theme\\(spacing\\.7\\)-theme\\(spacing\\.5\\)\\)\\/2\\)\\] {
  margin-top: calc((28px - 20px) / 2);
  margin-bottom: calc((28px - 20px) / 2);
}
.-mr-2 {
  margin-right: -8px;
}
...
:root,.light,[data-theme="light"] {
  ...
  --nextui-font-size-tiny: 12px;
  --nextui-font-size-small: 14px;
  --nextui-font-size-medium: 16px;
  --nextui-font-size-large: 18px;
  --nextui-line-height-tiny: 16px;
  --nextui-line-height-small: 20px;
  --nextui-line-height-medium: 24px;
  --nextui-line-height-large: 28px;
...
.data-\\[placement\\=top-end\\]\\:before\\:-bottom-\\[calc\\(theme\\(spacing\\.5\\)\\/4_-_1\\.5px\\)\\][data-placement=top-end]::before {
  content: var(--tw-content);
  bottom: calc(calc(20px / 4 - 1.5px) * -1);
}
...
var _jsxFileName$1 = "/Users/aleksandr/WebstormProjects/image-upscaler/extension/src/pages/content/ui/app.tsx";
function App() {
  return /* @__PURE__ */ jsxDEV("html", {
    children: [/* @__PURE__ */ jsxDEV("head", {
      children: /* @__PURE__ */ jsxDEV("style", {
        children: css
      }, void 0, false, {
      ...
      children: /* @__PURE__ */ jsxDEV(NextUIProvider, {
        children: /* @__PURE__ */ jsxDEV(Container, {}, void 0, false, {
          fileName: _jsxFileName$1,
          lineNumber: 13,
          columnNumber: 11
        }, this)
...
const Container = () => {
  ...
  return /* @__PURE__ */ jsxDEV(Fragment, {
    children: /* @__PURE__ */ jsxDEV("div", {
      className: `app-closed cursor-pointer`,
      onClick: () => window.open("https://image-upscaler.pro/upscale"),
      children: /* @__PURE__ */ jsxDEV("div", {
        className: "w-[24px] h-[24px] bg-gray-700 rounded-sm"
      }, void 0, false, {
        fileName: _jsxFileName$1,
        lineNumber: 24,
        columnNumber: 9
...
var _jsxFileName = "/Users/aleksandr/WebstormProjects/image-upscaler/extension/src/pages/content/ui/index.tsx";
addHmrIntoView("@pages/content");
const container = document.createElement("div");
container.id = "image-upscaler";
document.body.append(container);
document.querySelector("#image-upscaler").attachShadow({
  mode: "open"
});
const target = document.querySelector("#image-upscaler").shadowRoot;
